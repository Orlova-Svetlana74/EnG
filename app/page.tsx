            ...
            <div className={styles.container__takeUs__container}>
              <div className={styles.container__takeUs__block1}>
                ...
                <div className={styles.container__takeUs__item}>
                  ...
                  <p>
                    Мы не предлагаем готовые решения — мы разрабатываем
                    уникальные сайты и приложения, которые учитывают особенности
                    вашего бизнеса и целевую аудиторию.
                  </p>
                </div>
              </div>
              <div className={styles.container__takeUs__block2}>
                <div className={styles.container__takeUs__item}>
                  ...
                  <p>
                    ...
                    создания сайтов и приложений, которые соответствуют
                ...
                <div className={styles.container__takeUs__item}>
                  ...
                  <p>
                    ...
                    популярными сервисами, пишем боты для Telegram, VK,
                    WhatsApp, Mini App, пишем системы автоматизации для бизнеса
                    и многое другое.
                  </p>
                </div>
              </div>
            ...
            <ul>
              ...
              <li>
                ...
                <p>
                  ...
                  подходим <br /> к каждому проекту <br /> с глубоким
                  пониманием.
                </p>
              </li>
            </ul>
